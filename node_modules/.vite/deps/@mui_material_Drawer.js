...
import {
  ...
  useRtl,
  useTheme
} from "./chunk-D77ZJZEY.js";
import "./chunk-PMZADICO.js";
import {
  require_jsx_runtime
} from "./chunk-KUJFDODU.js";
import {
  require_react_dom
...
var SvgIcon = React16.forwardRef(function SvgIcon2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiSvgIcon"
  });
  ...
  const hasSvgAsChild = React16.isValidElement(children2) && children2.type === "svg";
  const ownerState = {
    ...props,
    color,
    component,
...
var Slide = React19.forwardRef(function Slide2(props, ref) {
  const theme = useTheme();
  const defaultEasing = {
  ...
  return (0, import_jsx_runtime7.jsx)(TransitionComponent, {
    ...
    children: (state, {
      ...
      return React19.cloneElement(children2, {
        ref: handleRef,
        style: {
          visibility: state === "exited" && !inProp ? "hidden" : void 0,
          ...style,
...
true ? Slide.propTypes = {
   ...
   */
  container: chainPropTypes(import_prop_types14.default.oneOfType([HTMLElementType, import_prop_types14.default.func]), (props) => {
    if (props.open) {
   ...
   * @default 'down'
   */
  direction: import_prop_types14.default.oneOf(["down", "left", "right", "up"]),
  /**
   * The transition timing function.
   * You may specify a single easing or a object containing enter and exit values.
   * @default {
...
var Drawer = React21.forwardRef(function Drawer2(inProps, ref) {
  ...
  const drawer = (0, import_jsx_runtime9.jsx)(PaperSlot, {
    ...paperSlotProps,
    children: children2
  });
  if (variant === "permanent") {
    return (0, import_jsx_runtime9.jsx)(DockedSlot, {
      ...dockedSlotProps,
      children: drawer
    });
  }
  const slidingDrawer = (0, import_jsx_runtime9.jsx)(TransitionSlot, {
    ...transitionSlotProps,
    children: drawer
  });
...
true ? Drawer.propTypes = {
   ...
   * @default 'left'
   */
  anchor: import_prop_types16.default.oneOf(["bottom", "left", "right", "top"]),
  /**
   * @ignore
   */
   ...
   * @default {}
   */
  ModalProps: import_prop_types16.default.object,
  /**
   * Callback fired when the component requests to be closed.
   * The `reason` parameter can optionally be used to control the response to `onClose`.
   *
   ...
   */
  SlideProps: import_prop_types16.default.object,
  /**
   * The props used for each slot inside.
   * @default {}
   */
  slotProps: import_prop_types16.default.shape({
    ...
    docked: import_prop_types16.default.oneOfType([import_prop_types16.default.func, import_prop_types16.default.object]),
  ...
  slots: import_prop_types16.default.shape({
    ...
    docked: import_prop_types16.default.elementType,
   ...
   * @default 'temporary'
   */
  variant: import_prop_types16.default.oneOf(["permanent", "persistent", "temporary"])
} : void 0;
